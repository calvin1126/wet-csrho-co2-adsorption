...
def identify_cations_interacting_co2(thres, i_ele, ele2, atoms):
    '''
    ...
    dist_select_o1 = [i_dist for i_dist in dist_o1_cs if i_dist < thres]
    ...
    dist_select_o2 = [i_dist for i_dist in dist_o2_cs if i_dist < thres]
...
def classify_interacting_cs(thres, traj, i_ele, ele2, all=False):
    '''
    ...
    for atoms in traj:
        ...
        o_cs_index = identify_cations_interacting_co2(thres, i_ele, ele2, atoms)  # identify cs+ that are interacting with CO2
...
for i_ele in range(len(indices[ele1])):
    traj_target_wrapped, num_cs_total, num_cs_d8r, num_cs_s6r = classify_interacting_cs(thres, traj, i_ele, ele2)
